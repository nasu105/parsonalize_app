            ...
            <tbody>
              ...
              <tr>
                <!-- 詳細画面へのリンク -->
                  ...
                  <td><a href="{{ route('admin.usersitem.supported_show',$order_item->id) }}">{{ $order_item->user->name }}</a></td>
                  <td><a href="{{ route('admin.usersitem.supported_show',$order_item->id) }}">¥{{ $order_item->price }}</a></td>
